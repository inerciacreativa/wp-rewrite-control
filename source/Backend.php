...
class Backend extends PluginClass
{
	...
	protected function initialize(): void
	{
		Settings::siteOptions($this->id(), $this->getOptions(), $this->name())
		        ->addTab('general', function (Tab $tab) {
			        $tab->setTitle(__('General', $this->id()));
			        ...
			        $tab->addSection('performance', function (Section $section) {
			        ...
			        $tab->addSection('cors', function (Section $section) {
			        ...
			        $tab->addSection('sw', function (Section $section) {
			        ...
			        $tab->addSection('other', function (Section $section) {
			        ...
			        $tab->onValidation(function (array $values) {
		        ...
		        ->addTab('security', function (Tab $tab) {
			        $tab->setTitle(__('Security', $this->id()));

			        $tab->addSection('general', function (Section $section) {
			        ...
			        if ($this->getPlugin()->hasHttps()) {
				        $tab->addSection('hsts', function (Section $section) {
			        ...
			        $tab->addSection('advanced', function (Section $section) {
		        ...
		        ->addTab('csp', function (Tab $tab) {
			        $tab->setTitle(__('CSP', $this->id()));
			        ...
			        $tab->addSection('services', function (Section $section) {
			        ...
			        $tab->addSection('fetch', function (Section $section) {
			        ...
			        $tab->addSection('document', function (Section $section) {
			        ...
			        $tab->addSection('navigation', function (Section $section) {
			        ...
			        $tab->addSection('special', function (Section $section) {
		        ...
		        ->addTab('wordpress', function (Tab $tab) {
			        ...
			        $tab->setTitle(__('WordPress', $this->id()))
